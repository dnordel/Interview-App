...
| `config/interview_output.schema.json` | `interview_runtime` | `scoring_reporting`, `interview_runtime` | Draft 2020-12 JSON schema describing interview output payload shape and constraints. |
