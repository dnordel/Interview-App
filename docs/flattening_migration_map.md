...
- Retired platform wrappers for `artifact_cleanup`, `config_adapters`, and `ux_metrics` have been removed; active wrappers remain tracked below.
...
- Retired onboarding wrappers for action sections, dashboard actions, reminder health, and send guardrails have been removed.
