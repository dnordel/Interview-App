...
NOTIFICATION_TEMPLATE_FIELD_CATALOG = (
    ...
    NotificationTemplateField("task_title", "Task title", "Onboarding"),
    NotificationTemplateField("owner_role", "Task owner role", "Onboarding"),
    NotificationTemplateField("task_count", "Task count", "Onboarding"),
    NotificationTemplateField("due_date", "Task due date", "Onboarding"),
